...
[MAC_BASE] = LAYOUT_tkl_ansi(
     KC_ESC,   IN_ML0,   IN_ML1,   IN_ML2,   IN_ML3,  RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,            KC_SNAP,   KC_SIRI,  RGB_MOD,
     KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,   BK_KC,   KC_INS,    KC_HOME,  KC_PGUP,
     KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,  KC_BSLS, MU_TOG,    BK_TOG,   KC_PGDN,
...
extern uint8_t indicator_macro;
extern uint8_t indicator_mute;
extern uint8_t indicator_backspace;
extern uint8_t indicator_hid;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record){
    ...
    //     break;
        ...
        case MU_TOG:
           if(record->event.pressed) {
                register_code(KC_LCMMD);
                register_code(KC_LSFT);
                register_code(KC_W);
           } else {
                unregister_code(KC_LCMMD);
